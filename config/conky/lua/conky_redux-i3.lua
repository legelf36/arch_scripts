...
{-- cpu0
    ...
    x=22,           y=250,          x2=18,              y2=200,
    offsetx=5,      offsety=4,      w=155,               h=15,           c_r=3,
    ...
    txt_fg_colour=0x999999,         txt_fg_alpha=1,                     graduation_radius=12,
...
{-- cpu1
    ...
    hand_fg_colour=0xEF5A29,        hand_fg_alpha=1,
    shadow_colour=0x111111,         shadow_alpha=0,
    txt_radius=8,                   txt_weight=0,                       txt_size=7.0,
...
{-- gpu2
    name='nvidia',                  arg="nvidia-smi --query-gpu=power.draw --format=csv,noheader,nounits",
    max_value=120,
    x=22,           y=250,          x2=18,              y2=240,
    offsetx=5,      offsety=4,      w=155,               h=15,           c_r=3,
    font='MesloLGM',         font_size=22,           font_style='CAIRO_FONT_WEIGHT_NORMAL',
    font_colour=0xFFFFFF,           font_colour_alpha=1.0,  font_slant='CAIRO_FONT_SLANT_NORMAL',
    graph_radius=12,                graph_thickness=4,
    graph_start_angle=180,          graph_unit_angle=2.7,               graph_unit_thickness=2.7,
    graph_bg_colour=0x447744,       graph_bg_alpha=0.3,
    graph_fg_colour=0xBBBB88,       graph_fg_alpha=0.5,
    hand_fg_colour=0xEF5A29,        hand_fg_alpha=1,
    shadow_colour=0x111111,         shadow_alpha=0,
    txt_radius=8,                   txt_weight=0,                       txt_size=14.0,
...
{-- gpu3
    name='nvidia',                  arg="nvidia-smi --query-gpu=clocks.mem --format=csv,noheader,nounits",
    max_value=6000,
    x=22,           y=250,          x2=18,              y2=260,
    offsetx=5,      offsety=4,      w=155,               h=15,           c_r=3,
    font='MesloLGM',         font_size=22,           font_style='CAIRO_FONT_WEIGHT_NORMAL',
    font_colour=0x555555,           font_colour_alpha=1.0,  font_slant='CAIRO_FONT_SLANT_NORMAL',
    graph_radius=12,                graph_thickness=4,
    graph_start_angle=180,          graph_unit_angle=2.7,               graph_unit_thickness=2.7,
    graph_bg_colour=0x447744,       graph_bg_alpha=0.3,
    graph_fg_colour=0xBBBB88,       graph_fg_alpha=0.5,
    ...
    graduation_thickness=5,         graduation_mark_thickness=1,        graduation_unit_angle=27,
    graduation_fg_colour=0xFFFFFF,  graduation_fg_alpha=0.8,
    caption=' Mhz(mem)',          caption_weight=1,                   caption_size=12.0,
    caption_fg_colour=0xFFFFFF,     caption_fg_alpha=1.0,
},
{-- gpu4
    name='nvidia',                  arg="nvidia-smi --query-gpu=clocks.video --format=csv,noheader,nounits",
    max_value=6000,
    x=22,           y=250,          x2=18,              y2=280,
    offsetx=5,      offsety=4,      w=155,               h=15,           c_r=3,
    font='MesloLGM',         font_size=22,           font_style='CAIRO_FONT_WEIGHT_NORMAL',
    font_colour=0x555555,           font_colour_alpha=1.0,  font_slant='CAIRO_FONT_SLANT_NORMAL',
    graph_radius=12,                graph_thickness=4,
    ...
    graduation_thickness=5,         graduation_mark_thickness=1,        graduation_unit_angle=27,
    graduation_fg_colour=0xFFFFFF,  graduation_fg_alpha=0.8,
    caption=' Mhz(vid)',          caption_weight=1,                   caption_size=12.0,
    caption_fg_colour=0xFFFFFF,     caption_fg_alpha=1.0,
},
{-- gpu5
    name='nvidia',                  arg="nvidia-smi --query-gpu=clocks.gr --format=csv,noheader,nounits",
    max_value=6000,
    x=22,           y=250,          x2=18,              y2=300,
    offsetx=5,      offsety=4,      w=155,               h=15,           c_r=3,
    font='MesloLGM',         font_size=22,           font_style='CAIRO_FONT_WEIGHT_NORMAL',
    font_colour=0x555555,           font_colour_alpha=1.0,  font_slant='CAIRO_FONT_SLANT_NORMAL',
    graph_radius=12,                graph_thickness=4,
    ...
    graduation_thickness=5,         graduation_mark_thickness=1,        graduation_unit_angle=27,
    graduation_fg_colour=0xFFFFFF,  graduation_fg_alpha=0.8,
    caption=' Mhz(shad)',          caption_weight=1,                   caption_size=12.0,
    caption_fg_colour=0xFFFFFF,     caption_fg_alpha=1.0,
},
{-- gpu6
    name='nvidia',                  arg="nvidia-smi --query-gpu=clocks.sm --format=csv,noheader,nounits",
    max_value=6000,
    x=22,           y=250,          x2=18,              y2=320,
    offsetx=5,      offsety=4,      w=155,               h=15,           c_r=3,
    font='MesloLGM',         font_size=22,           font_style='CAIRO_FONT_WEIGHT_NORMAL',
    font_colour=0x555555,           font_colour_alpha=1.0,  font_slant='CAIRO_FONT_SLANT_NORMAL',
    graph_radius=12,                graph_thickness=4,
    ...
    graduation_thickness=5,         graduation_mark_thickness=1,        graduation_unit_angle=27,
    graduation_fg_colour=0xFFFFFF,  graduation_fg_alpha=0.8,
    caption=' Mhz(str)',          caption_weight=1,                   caption_size=12.0,
    caption_fg_colour=0xFFFFFF,     caption_fg_alpha=1.0,
},
}--
...
{ --current temp
    ...
    x=205,                           y=47,
    font='Meslo Nerd Font', font_size=22,           font_style='CAIRO_FONT_WEIGHT_NORMAL',
    font_colour=0xFFFFFF,           font_colour_alpha=1.0,  font_slant='CAIRO_FONT_SLANT_NORMAL',
    prefix='',                      suffix='°',
},
{ --humidity
    ...
    x=250,                           y=65,
    font='Meslo Nerd Font',         font_size=10,           font_style='CAIRO_FONT_WEIGHT_NORMAL',
...
{ --feels like
    ...
    x=170,                           y=65,
    font='Meslo Nerd Font',         font_size=12,           font_style='CAIRO_FONT_WEIGHT_NORMAL',
    font_colour=0xCCCCCC,           font_colour_alpha=1.0,  font_slant='CAIRO_FONT_SLANT_NORMAL',
...
{ --day of the week
    ...
    command="date +%A",
    x=20,                           y=75,
    font='MesloLGM', font_size=24,           font_style='CAIRO_FONT_WEIGHT_NORMAL',
    font_colour=0xFFFFFF,           font_colour_alpha=1.0,  font_slant='CAIRO_FONT_SLANT_NORMAL',
    prefix='',                      suffix='',
},
{ --day of the month
...
{ --hour
    ...
    command="date +%l",
    x=162,                           y=106,
    font='Source Sans Pro Regular', font_size=36,           font_style='CAIRO_FONT_WEIGHT_NORMAL',
    font_colour=0xFFFFFF,           font_colour_alpha=1.0,  font_slant='CAIRO_FONT_SLANT_NORMAL',
    prefix='',                      suffix='',
},
{ --minute
    ...
    command="date +%M",
    x=200,                           y=95,
    font='Source Sans Pro Regular', font_size=20,           font_style='CAIRO_FONT_WEIGHT_NORMAL',
    font_colour=0xFFFFFF,           font_colour_alpha=1.0,  font_slant='CAIRO_FONT_SLANT_NORMAL',
    prefix=':',                      suffix='',
},
{ --seconds
    ...
    command="date +%S",
    x=229,                           y=87,
    font='Source Sans Pro Regular', font_size=9,           font_style='CAIRO_FONT_WEIGHT_NORMAL',
    font_colour=0xFFFFFF,           font_colour_alpha=1.0,  font_slant='CAIRO_FONT_SLANT_NORMAL',
    prefix=':',                      suffix='',
},
{ --ampm
...
{-- Arcolinux logo
    name="arcologo",
    x=40,   y=-35,   w=120,   h=40,   rotation=0,
...
{-- wind arrow
    name="wind_direc",
    x=285,   y=28,   w=13,   h=13,   rotation=0,
...
local function draw_proc(display,data,value,str,str2)-- draw processor
    ...
    local fc, fa = data.font_colour, data.font_colour_alpha
    ...
    cairo_set_source_rgba(display,rgb_to_r_g_b(data.graph_bg_colour,val))
    cairo_set_line_width(display, 1)
    cairo_stroke(display)
    cairo_move_to(display,x+(ox-4),y+(oy*3))                                    --move to text position
    ...
    if data.name == 'cpu' then
        cairo_show_text(display,math.floor(val*100).."%")                        --text to display
    else
