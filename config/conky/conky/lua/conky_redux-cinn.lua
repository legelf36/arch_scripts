...
--[[{-- cpu0
    ...
    x=22,           y=250,          x2=18,              y2=290,
    offsetx=5,      offsety=4,      w=145,               h=15,           c_r=3,
    ...
    txt_radius=8,                   txt_weight=0,                       txt_size=14.0,
    txt_fg_colour=0x000000,         txt_fg_alpha=1,                     graduation_radius=12,
...
{-- cpu1
    ...
    x=22,           y=250,          x2=0,              y2=20,
    offsetx=5,      offsety=4,      w=10,               h=60,           c_r=2,
    graph_radius=12,                graph_thickness=4,
    graph_start_angle=180,          graph_unit_angle=2.7,               graph_unit_thickness=2.7,
...
{-- cpu8
    ...
    x=380,         y=395,          x2=170,               y2=215,
    offsetx=5,     offsety=4,      w=10,                 h=60,      c_r=2.25,
    graph_radius=12,               graph_thickness=4,
    graph_start_angle=180,         graph_unit_angle=2.7,          graph_unit_thickness=2.7,
    graph_bg_colour=0x99AA00,      graph_bg_alpha=0.3,
    graph_fg_colour=0x999966,      graph_fg_alpha=1,
...
local gpus = {--gpu DATA}
{-- gpu1
    name='nvidia',                  arg="nvidia-smi --query-gpu=utilization.gpu --format=csv,noheader,nounits",
    max_value=100,
    x=22,           y=250,          x2=18,              y2=315,
    offsetx=5,      offsety=4,      w=145,               h=15,           c_r=3,
    graph_radius=12,                graph_thickness=4,
    graph_start_angle=180,          graph_unit_angle=2.7,               graph_unit_thickness=2.7,
    ...
    graduation_thickness=5,         graduation_mark_thickness=1,        graduation_unit_angle=27,
    graduation_fg_colour=0xFFFFFF,  graduation_fg_alpha=0.8,
    caption='Utilization',          caption_weight=1,                   caption_size=12.0,
    caption_fg_colour=0xFFFFFF,     caption_fg_alpha=1.0,
},
{-- gpu2
    name='nvidia2',                  arg="nvidia-smi --query-gpu=fan.speed --format=csv,noheader,nounits",
    max_value=100,
    x=22,           y=250,          x2=18,              y2=335,
    offsetx=5,      offsety=4,      w=145,               h=15,           c_r=3,
    graph_radius=12,                graph_thickness=4,
    graph_start_angle=180,          graph_unit_angle=2.7,               graph_unit_thickness=2.7,
    graph_bg_colour=0xaaaaff,       graph_bg_alpha=0.3,
    graph_fg_colour=0xBBBB88,       graph_fg_alpha=0.5,
    hand_fg_colour=0xEF5A29,        hand_fg_alpha=1,
    shadow_colour=0x335511,         shadow_alpha=0,
    txt_radius=8,                   txt_weight=0,                       txt_size=14.0,
    txt_fg_colour=0x000000,         txt_fg_alpha=1,                     graduation_radius=12,
    graduation_thickness=5,         graduation_mark_thickness=1,        graduation_unit_angle=27,
    graduation_fg_colour=0xFFFFFF,  graduation_fg_alpha=0.8,
    caption='',                     caption_weight=1,                   caption_size=12.0,
    caption_fg_colour=0xFFFFFF,     caption_fg_alpha=1.0,
},
}
...
{ --current temp
    ...
    x=110,                           y=187,
    font='Source Sans Pro Regular', font_size=30,           font_style='CAIRO_FONT_WEIGHT_NORMAL',
    font_colour=0x999999,           font_colour_alpha=1.0,  font_slant='CAIRO_FONT_SLANT_NORMAL',
    prefix='',                      suffix='°',
},
{ --humidity
    name='humidity',
...
{ --weather description
    ...
    x=20,                           y=155,
    font='Meslo Nerd Font', font_size=10,           font_style=1,
    font_colour=0xccccdd,           font_colour_alpha=1.0,  font_slant='1',
    prefix='',                      suffix='',
},
{ --windspeed
    name='wind_speed',
...
--[[{ --wind direction 2
    ...
    font_colour=0x336633,           font_colour_alpha=1.0,  font_slant='CAIRO_FONT_SLANT_NORMAL',
...
{ --day of the week
    ...
    command="date +%A",
    x=20,                           y=75,
    font='Meslo Nerd Font', font_size=16,           font_style='1',
    font_colour=0xcccccc,           font_colour_alpha=1.0,  font_slant='CAIRO_FONT_SLANT_NORMAL',
    prefix='',                      suffix='',
},
{ --day of the month
    ...
    command="date +%-d",
    x=20,                           y=100,
    font='Meslo Nerd Font', font_size=26,           font_style='CAIRO_FONT_WEIGHT_NORMAL',
    font_colour=0xcccccc,           font_colour_alpha=1.0,  font_slant='CAIRO_FONT_SLANT_NORMAL',
    prefix='',                      suffix='',
},
{ --month
    ...
    command="date +%B",
    x=55,                           y=100,
    font='Meslo Nerd Font', font_size=18,           font_style='CAIRO_FONT_WEIGHT_NORMAL',
    font_colour=0xaaaaaa,           font_colour_alpha=1.0,  font_slant='CAIRO_FONT_SLANT_NORMAL',
    prefix='',                      suffix='',
},
{ --hour
    name='hour',
    command="date +%l",
    x=30,                           y=135,
    font='Meslo Nerd Font', font_size=30,           font_style='CAIRO_FONT_WEIGHT_NORMAL',
    font_colour=0x00dd00,           font_colour_alpha=0.75,  font_slant='CAIRO_FONT_SLANT_NORMAL',
    prefix='',                      suffix='',
},
{ --minute
    name='miniute',
    ...
    x=63,                           y=135,
    font='Source Sans Pro Regular', font_size=30,           font_style='CAIRO_FONT_WEIGHT_NORMAL',
    font_colour=0x00dd00,           font_colour_alpha=0.85,  font_slant='CAIRO_FONT_SLANT_NORMAL',
    prefix=':',                      suffix='',
},
{ --seconds
    name='seconds',
    ...
    x=108,                           y=124,
    font='Source Sans Pro Regular', font_size=12,           font_style='CAIRO_FONT_WEIGHT_NORMAL',
    font_colour=0x00dd00,           font_colour_alpha=1.0,  font_slant='CAIRO_FONT_SLANT_NORMAL',
    prefix=':',                      suffix='',
},
{ --ampm
    name='ampm',
    command="date +%p",
    x=112,                           y=137,
    font='Source Sans Pro Regular', font_size=8,           font_style='1',
    font_colour=0xbbbbbb,           font_colour_alpha=1.0,  font_slant='0',
    prefix='',                      suffix='',
},
{ --sysinfo
    name='sysinfo',
...
{ --kernel
    ...
    command="uname -r",
    x=68,                           y=40,
    font='Source Sans Pro', font_size=11,           font_style='CAIRO_FONT_WEIGHT_NORMAL',
    font_colour=0x999999,           font_colour_alpha=1.0,  font_slant='CAIRO_FONT_SLANT_NORMAL',
    prefix='',                      suffix='',
},
{ --sunrise
...
{ --cpu temp
    ...
    x=115,                           y=303,
    font='Meslo Nerd Font', font_size=12,           font_style=0,
    font_colour=0xcc6600,           font_colour_alpha=1.0,  font_slant=0,
    prefix='',                      suffix='',
},
{ --gpu temp
    name='gtemp',
...
{ --gpu power draw
    ...
    font_colour=0x99ff99,           font_colour_alpha=1.0,  font_slant='0',
    prefix='',                      suffix='',
},
{ --gpu shader clock
    name='gshclock',
    command="nvidia-smi --query-gpu=clocks.gr --format=csv,noheader",
    x=20,                           y=431,
    font='Meslo Nerd Font', font_size=10,           font_style='CAIRO_FONT_WEIGHT_BOLD',
    font_colour=0x99ff99,           font_colour_alpha=1.0,  font_slant='CAIRO_FONT_SLANT_NORMAL',
    prefix='GPU Shader: ',                      suffix='',
},
{ --gpu memory clock
    name='gmemclk',
...
{ --gpu sm clock
    name='gsmclk',
    command="nvidia-smi --query-gpu=clocks.sm --format=csv,noheader",
    --command="nvidia-smi --query-gpu=encoder.stats.averageFps --format=csv,noheader",
    x=20,                           y=455,
    font='Meslo Nerd Font', font_size=10,           font_style='CAIRO_FONT_WEIGHT_BOLD',
    font_colour=0x99ff99,           font_colour_alpha=1.0,  font_slant='CAIRO_FONT_SLANT_NORMAL',
    prefix='GPU Stream: ',                      suffix='',
},
{ --gpu video clock
    name='gvclk',
    command="nvidia-smi --query-gpu=clocks.video --format=csv,noheader",
    x=20,                           y=467,
    font='Meslo Nerd Font', font_size=10,           font_style='CAIRO_FONT_WEIGHT_BOLD',
    font_colour=0x99ff99,           font_colour_alpha=1.0,  font_slant='CAIRO_FONT_SLANT_NORMAL',
...
local function cp_weather()-- copy weather icon to "current.png"
    local c2 = "cp -f ~/.config/conky/images/weather-icons/64px-multicolor/$(jq .weather[0].id ~/.cache/weather.json).png ~/.cache/current.png"
...
local function draw_proc(display,data,value,str,str2)-- draw processor
    ...
    if data.max_value <> 100 then
        cairo_set_source_rgba(display,rgb_to_r_g_b(0xffffff,value)
    else
        cairo_set_source_rgba(display,rgb_to_r_g_b(0xffffff,value))             --line colour
    end
    ...
    cairo_move_to(display,x+(ox*1),y+(oy*3.2))                                    --move to text position
    ...
    if data.name == 'nvidia' then
        cairo_show_text(display,"GPU "..math.floor(value*100).." %")
    elseif data.arg == 'cpu0' then
        cairo_show_text(display,"CPU "..math.floor(value*100).." %")
    elseif data.name == 'nvidia2' then
        cairo_show_text(display,"GPU Fan "..math.floor(value*100).." %")
    --elseif data.name == 'nvidia3' then
        --cairo_show_text(display,"GPU Power "..math.floor(value*100).." %")
    --end
...
local function graphics_load(display)-- init gauge rings.
    ...
    --[[local function load_gproc(display,data)
        local str, value = '', '', 0
        str = conky_ownpreexec_noend(data.arg)
        value = str/100
        draw_proc(display, data, value)
    end]]--
...
local function text_load(display)-- Show text.
    ...
    if (os.date("%M")%5) == 0 and (os.date("%S")%30) == 0 then cp_weather() end
